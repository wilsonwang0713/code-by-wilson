...
Open the app. Every session already running on your machine — anything Claude Code
has touched — shows up immediately in the session rail on the left, grouped by
