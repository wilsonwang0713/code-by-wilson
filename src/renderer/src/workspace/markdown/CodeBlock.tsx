 ...
 * `langClassName` on group/code hover, and suppressed entirely for plain `text` fences so a
 * no-language block shows no badge), and the copy button (icon + "Copy") fades in. The button
