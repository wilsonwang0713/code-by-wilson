...
export const MODE_INFO: Record<Management, ModeInfo> = {
  managed: {
    ...
    label: "Managed",
    blurb:
      "Spawned and driven by FlightDeck. You can send input, interrupt it, and end it from here.",
  },
  observed: {
    kind: "observed",
    label: "Observed",
    blurb:
      "Running in another terminal or machine. FlightDeck mirrors its transcript read-only. You can't type in. Adopt it to take the wheel.",
  },
};
